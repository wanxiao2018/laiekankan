(function (root, factory) {
  ...
  const places = [
    ...
    { id: 'bronze', name: '青铜骑士像', ru: 'Медный всадник', address: 'Сенатская площадь, Санкт-Петербург', category: 'landmark', area: 'center', tag: '涅瓦河畔', time: '建议 20–30 分钟', intro: '青铜骑士像是彼得大帝的骑马雕像，位于涅瓦河畔的元老院广场。', note: '室外停留点，可以根据风雨和体力灵活缩短。', source: 'https://en.wikipedia.org/wiki/Bronze_Horseman', sourceLabel: '青铜骑士像资料' },
    ...
    { id: 'park300', name: '300 周年公园', ru: 'Парк 300-летия Санкт-Петербурга', address: 'Приморский проспект, 74, Санкт-Петербург', category: 'nature', area: 'coast', tag: '芬兰湾海风', time: '建议 1–2 小时', intro: '300 周年公园有开阔的芬兰湾海岸，适合看海和城市天际线。', note: '离传统市中心较远；海边风力和体感随日期变化，按当天预报安排。', source: 'https://en.wikipedia.org/wiki/Park_of_the_300th_Anniversary_of_Saint_Petersburg', sourceLabel: '300 周年公园资料' },
    { id: 'literary', name: '文学咖啡馆', ru: 'Литературное кафе', address: 'Невский проспект, 18, Санкт-Петербург', category: 'life', area: 'center', tag: '文学与午后', time: '建议 1 小时', intro: '文学咖啡馆位于涅瓦大街，适合对文学主题餐厅感兴趣的游客。', note: '餐位、菜单与消费以店家当天信息为准。', source: 'https://ru.wikipedia.org/wiki/Литературное_кафе_(Санкт-Петербург)', sourceLabel: '文学咖啡馆资料' },
  ...
  return {
    ...
    sources: [ ['俄罗斯博物馆与花园','https://rusmuseum.ru/museums/'], ['Russiable 彼得堡旅行指南','https://russiable.com/what-see-do-st-petersburg/'] ],
